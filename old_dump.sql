...
CREATE DEFINER=`root`@`%` PROCEDURE `sp_estados_save` (IN `pidprotocolo` INT(6), IN `pestado` VARCHAR(56), IN `pdata` DATE)  NO SQL
BEGIN

	INSERT INTO tb_protocolos_estado (idprotocolo, estado, data) VALUES (pidprotocolo, pestado, pdata);
...
(5, '2018-10-07 01:13:11', 'JoÃ£o Pedro da Cruz Melo', '', '471.088.668-70', '', '', '(11) 2154-0597', '(11) 96300-5537', '03917-050', 'Rua Caetano Pero Neto, 141', 'Jardim Porteira Grande', 'SÃ£o Paulo', 'SP', 'joao.pedro6532@gmail.com', '', '', 'PF', 'Admin', '2018-10-06 22:13'),
(6, '2018-10-07 01:17:12', 'Lucas Gabriel', '', '834.144.990-02', '', '', '(11) 2497-4314', '(11) 95411-3374', '03380-050', 'Rua Salvador Rolla, 210', 'ChÃ¡cara Belenzinho', 'SÃ£o Paulo', 'SP', 'lucas.gabriel@gmail.com', '', '', 'PF', 'Admin', '2018-10-06 22:17');
...
(5, 5, 'JoÃ£o Pedro da Cruz Melo', 'joao.melo', 'bfeb2df4', '2018-10-07 01:13:11'),
(6, 6, 'Lucas Gabriel', 'lucas.gabriel', '908a831c', '2018-10-07 01:17:12');
...
(17, 5, 1, 'CVAPROTOCOL-8BADD417', '2018-10-12 00:34:40'),
(18, 6, 2, 'CVAPROTOCOL-3FD304F4', '2018-10-12 00:35:43');

CREATE TABLE `tb_protocolos_estado` (
  `id` int(6) NOT NULL,
  `idprotocolo` int(6) NOT NULL,
  `estado` varchar(56) CHARACTER SET utf8mb4 NOT NULL,
  `data` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `tb_protocolos_estado` (`id`, `idprotocolo`, `estado`, `data`) VALUES
(25, 17, 'AutomaÃ§Ã£o finalizada', '2018-10-11'),
(26, 17, 'AutomaÃ§Ã£o iniciada', '2018-10-10'),
(27, 18, 'Visita tÃ©cnica realizada', '2018-10-09');
...
(8, '2018-10-11', 17, '4500.20', '2018-10-18', NULL, '', 'Boleto', '1/1', '', 'E-mail', 'Admin', 10, 2018, 'Admin', '2018-10-11 22:15');
...
(1, 'AutomaÃ§Ã£o', '2018-10-06 02:13:53'),
(2, 'Visita TÃ©cnica', '2018-10-07 01:12:29');
