            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="inscricaoEstadual" value="<?php echo htmlspecialchars( $cliente["inscricaoEstadual"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                    disabled>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="endereco" name="endereco" value="<?php echo htmlspecialchars( $cliente["endereco"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                    disabled>
                </div>
              </div>
            </div>
                ...
                <div class="table-responsive">
                  <table class="table text-center">
                    ...
                    <div class="alert alert-danger" role="alert">
                      ...
                      Climatização. <a href="http://www.cvaclimatizacao.com.br" class="btn btn-danger" data-toggle="tooltip"
                        data-placement="right" title="Realizar negócios com a CVA Climatização!">Começe por aqui!</a>
                    </div>
                </div>
                <?php } ?>
                </table>
