  ...
  <div class="wrapper">
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="\\assets/img/sidebar-3.jpg">
      ...
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          <li class="nav-item <?php if( $_SERVER['REQUEST_URI'] === '/admin/painel' ){ ?>active<?php } ?>" data-toggle="tooltip" data-placement="right" title="Painel com dados analíticos da CVA Admin">
