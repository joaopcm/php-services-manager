        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-right">
                                ...
                                <a href="/adicionar/recebimento" class="btn btn-primary btn-lg">Adicionar Recebimento</a> <?php } ?>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/visualizar/cliente/<?php echo htmlspecialchars( $value1["idcliente"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["cliente"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="/visualizar/protocolo/<?php echo htmlspecialchars( $value1["idprotocolo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><p id="p<?php echo htmlspecialchars( $value1["idprotocolo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="display: inline"><?php echo htmlspecialchars( $value1["codigo"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
                ...
                <div class="alert alert-danger " role="alert ">
                  <strong>Ah não!</strong> Não existem cadastros de recebimentos em <strong><?php echo htmlspecialchars( $mes, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $ano, ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> em nossos registros. <a href="/adicionar/recebimento " class="btn btn-danger " data-toggle="tooltip " data-placement="right " title="ATENÇÃO!
