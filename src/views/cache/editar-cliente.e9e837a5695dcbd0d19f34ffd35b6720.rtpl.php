            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Edite um cliente para <?php echo getenv('APP_NAME'); ?></p>
                </div>
                <div class="card-body">
                  <form action="/admin/editar/cliente/<?php echo htmlspecialchars( $cliente["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="POST">
                    <div class="row">
                      <div class="col-md-5">
