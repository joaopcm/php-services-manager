...
$(document).ready(function () {
	...
	initDashboardPageCharts: function () {
		if (0 != $("#clientes-mes-chart").length || 0 != $("#completedTasksChart").length || 0 != $("#recebimentos-mes-chart").length) {
            ...
            $.ajax({
                type: "POST",
                url: "/preencher/clientes-mes-chart",
                ...
                error: function() {
                    console.log("CVA Error - Não foi possível extrair dados do banco de dados.");
                },
                async: false
            });
			...
			$.ajax({
                type: "POST",
                url: "/preencher/recebimentos-mes-chart",
                success: function(f) {
					f = $.parseJSON(f);
					f = f[0];
					if (f != null && f != ''){
			...
			var i = Chartist.Bar("#recebimentos-mes-chart", {
				labels: ["J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"],
				series: [
				...
				low: 0,
				high: parseInt(p_obj['maior_valor'], 10) - 4500,
				chartPadding: {
					top: 0,
					right: 0,
					bottom: 0,
