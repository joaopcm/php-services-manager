          ...
          <div class="card-header card-header-primary">
            <div class="row">
              ...
              <div class="col-md-4 text-right">
                ...
                <a href="/adicionar/cliente" class="btn btn-primary btn-lg">Adicionar Cliente</a>
                <?php } ?>
              </div>
            </div>
          </div>
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    <?php if( $_SESSION['User']['acessoTotal'] === '1' ){ ?>
                    <td>
                      <a href="/excluir/cliente/<?php echo htmlspecialchars( $value1["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-danger btn-table" onclick="return confirm('Deseja realmente excluir este cliente?')" data-toggle="tooltip"
                        data-placement="right" title="Excluir">
                        <i class="material-icons">close</i>
                      </a>
                      <a href="/editar/cliente/<?php echo htmlspecialchars( $value1["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-success btn-table" data-toggle="tooltip" data-placement="right" title="Editar">
                    ...
                    <?php } ?>
                    <td>
                      <a href="/visualizar/cliente/<?php echo htmlspecialchars( $value1["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["nomeCliente"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                ...
                <div class="alert alert-danger" role="alert">
                  ...
                  <a href="/adicionar/cliente" class="btn btn-danger">Cadastrar um cliente</a>
                </div>
                <?php } ?>
              </table>
            </div>
